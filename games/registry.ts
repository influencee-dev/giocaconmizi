...
export const games: GameMeta[] = [
  ...
  { slug: "dove-arriva-mizi", title: "Dove arriva Mizi?", ageMin: 6, ageMax: 8, skill: "coding", subskill: "leggere ed eseguire un programma", difficulty: 2, minutes: 4, mechanic: "Programma di frecce già scritto sotto una griglia; il bambino lo esegue con gli occhi e tocca l'oggetto sulla cella d'arrivo fra 3.", status: "live" },
  { slug: "salto-di-mizi", title: "Il salto di Mizi", ageMin: 7, ageMax: 10, skill: "coding", subskill: "condizioni: se, allora, altrimenti", difficulty: 2, minutes: 4, mechanic: "Fila di caselle, alcune azzurre; regola SE azzurra salta 2 ALTRIMENTI 1 passo; N mosse; tocca l'oggetto sulla casella dove finisce Mizi fra 3.", status: "live" },
  { slug: "missione-ghiaccio", title: "Missione sul ghiaccio", ageMin: 8, ageMax: 11, skill: "coding", subskill: "algoritmi e cicli, livelli esperti", difficulty: 3, minutes: 8, mechanic: "Blocchi avanti/gira su griglie 5x5-6x6 con muri che obbligano a deviare; ultimi 3 livelli risolvibili SOLO col ripeti (verificati con solver).", status: "live" },
